...
## Context
The current project is isolated. Do not inspect any parent or sibling project, shared launcher database, other project run directory, browser history, or external Cairn API. Use only this graph snapshot and this project's workspace.
